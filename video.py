...
class VideoCap:
    labels = {OBJ_IDX_CLOSEWINDOW: 'windowclose', OBJ_IDX_OPENWINDOW: 'windowopen'}
    def __init__(self, w: int, h: int, url: str, min_iou_threshold: float) -> None:
        ...
        self.out = cv2.VideoWriter('output1.avi',fourcc, 20.0, (round(w),round(h)))
        ...
        # self.warning = Warning_gen(min_iou_threshold)
